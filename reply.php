...
<font size="3"<i><b>&nbsp;To:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></i></font><input value="<?php echo $row['sender'];?>"size="100" name="reciever" />
<input type="image" src="send.jpg" alt="Submit" width="60" height="40" style="position:absolute;top:175px;left:1037px">
<br/>
<div><font size="3"<i><b>&nbsp;Subject:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></i></font><input value="<?php echo $row['subject'];?>" size="100" name="subject"/></div>
